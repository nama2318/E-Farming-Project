   ...
   <div class="sell_crop_div">
            ...
            <div class="sidebar">
                ...
                <li>
                    ...
                    <li><a href="#" active style="color:#f6ff41"><li>Sell Crop</li></a>
    ...
    <table><form action="addcrop.php">
        ...
        <label for=""><center> <H2>YOUR ADVERTISEMENT</H2></center> </label>
                        
        <button type="submit" class="crud-btn">New Crop</button></form></caption>
        <br>
        <th>CROP NAME</th>
        <th>CROP IMAGE</th>
        <th>EXPECTED PRICE (Rs./KG)</th>
        <th>QTY (Kg.)</th>
        ...
        <?php
            ...
            $sql = "SELECT * FROM crop_table where farmer_email = '{$userid}'";
            ...
            if(!$result){
                ...
                while($row = $result->fetch_assoc()){
                    ...
                    <tr>
                        ...
                        <button type='button' class='crud-btn  details-btn' id='details-btn'><a href='farmer_adv.php?id=$row[crop_id]'>DETAILS</a></button>

                        <button type='button' class='crud-btn delete-btn' id='delete-btn'><a href='../php/deletef.php?id=$row[crop_id]'>DELETE</a></button>
                    ...
                    if($row["order_status"] == 'REQUESTED'){
                        ...
                        <button type='button' class='crud-btn  confirm-btn' id='confirm-btn'><a href='../php/confirmrequest.php?id=$row[crop_id]'>CONFIRM</a></button>

                        <button type='button' class='crud-btn cancel-btn' id='cancel-btn'><a href='../php/cancelrequest.php?id=$row[crop_id]'>CANCEL</a></button>
